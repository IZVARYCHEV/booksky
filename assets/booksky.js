...
;define("booksky/controllers/index", ["exports"], function (_exports) {
  ...
  var IndexController = (_dec = Ember._tracked, _dec2 = Ember._action, _dec3 = Ember._action, (_class = (_temp = /*#__PURE__*/function (_Ember$Controller) {
    ...
    function IndexController() {
      ...
      _initializerDefineProperty(_assertThisInitialized(_this), "tags", _descriptor, _assertThisInitialized(_this));
  ...
  }(Ember.Controller), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "tags", [_dec], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
...
;define("booksky/routes/author", ["exports"], function (_exports) {
  ...
  var AuthorRoute = (_dec = Ember.inject.service, (_class = (_temp = /*#__PURE__*/function (_Ember$Route) {
    _inherits(AuthorRoute, _Ember$Route);

    var _super = _createSuper(AuthorRoute);

    function AuthorRoute() {
      var _this;

      _classCallCheck(this, AuthorRoute);
...
;define("booksky/routes/author/detail", ["exports"], function (_exports) {
  ...
  var AuthorDetailRoute = (_dec = Ember.inject.service, (_class = (_temp = /*#__PURE__*/function (_Ember$Route) {
    _inherits(AuthorDetailRoute, _Ember$Route);

    var _super = _createSuper(AuthorDetailRoute);

    function AuthorDetailRoute() {
      var _this;

      _classCallCheck(this, AuthorDetailRoute);
    ...
    _createClass(AuthorDetailRoute, [{
      key: "model",
...
;define("booksky/services/data-service", ["exports"], function (_exports) {
  ...
  var DataServiceService = /*#__PURE__*/function (_Ember$Service) {
    ...
    _createClass(DataServiceService, [{
      key: "readAuthors",
      value: function () {
        var _readAuthors = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var url, response;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
...
;
          if (!runningTests) {
            require("booksky/app")["default"].create({"backEndURL":"http://localhost:3000","name":"booksky","version":"0.0.0+4c4ab080"});
          }
